...
const I18N = {
  ru: {
    ...
    /* ------------------------------------------------------------ герой */
    'hero.kicker': 'VitalityTr · с 2026 года',
    ...
    'prod.develop': 'Выстроите структурный подход к рынку, автоматизируете торговлю и глубже разберётесь в системе VitalityTr SM PRO.',
    'prod.buy': 'Купить продукты VitalityTr SM PRO',
    'prod.ind.label': 'Индикатор',
    'prod.ind.h': 'VitalityTr SM PRO — индикатор',
    ...
    'prod.bot.h': 'VitalityTr SM PRO — торговый робот',
    'prod.bot.p': 'Автоматический торговый робот, работающий по той же логике, что и VitalityTr SM PRO. Помогает автоматизировать процесс и выполнять заданные правила без эмоционального вмешательства.',
    'prod.man.label': 'Руководство',
    'prod.man.h': 'VitalityTr SM PRO — руководство',
    'prod.man.p': 'Подробное руководство по системе VitalityTr SM PRO. Объясняет логику системы, ключевые элементы и правила применения индикатора и торгового подхода.',
    ...
    'about.title': 'Кто мы',
    'about.who.h': 'Кто мы',
    'about.who.p': 'VitalityTr SM PRO — бренд торговых технологий, сосредоточенный на разработке инструментов для финансовых рынков. Мы соединяем концепции Smart Money, анализ структуры рынка и современные торговые технологии, создавая практичные решения.',
    ...
    'foot.rights': '© 2026 VitalityTr. Все права защищены.',
  ...
  en: {
    ...
    'hero.kicker': 'VitalityTr · since 2026',
    ...
    'prod.develop': 'Develop a structured approach to the market, automate your trading, and delve deeper into the VitalityTr SM PRO system.',
    'prod.buy': 'Buy VitalityTr SM PRO products',
    'prod.ind.label': 'Indicator',
    'prod.ind.h': 'VitalityTr SM PRO — indicator',
    ...
    'prod.bot.h': 'VitalityTr SM PRO — trading robot',
    'prod.bot.p': 'An automated trading robot designed to operate using the same logic as VitalityTr SM PRO. It helps automate the trading process and execute preset rules without emotional intervention.',
    'prod.man.label': 'Manual',
    'prod.man.h': 'VitalityTr SM PRO — manual',
    'prod.man.p': "A detailed guide to the VitalityTr SM PRO system. Explains the system's logic, key elements, and rules for using the indicator and trading approach.",
    ...
    'about.who.p': 'VitalityTr SM PRO is a professional trading technology brand focused on developing innovative tools for financial markets. We combine Smart Money Concepts, market structure analysis and advanced trading technology to create practical solutions.',
    ...
    'foot.rights': '© 2026 VitalityTr. All rights reserved.',
